...
> **Companion app:** [**Lyceum-App**](https://github.com/Patryk-beep/Lyceum-App) turns this learning system into a standalone, interactive application (in development) — [see the page](https://patryk-beep.github.io/Lyceum-App/).
...
[**Lyceum-App**](https://github.com/Patryk-beep/Lyceum-App) is the companion application that turns Lyceum's nine-skill, evidence-based learning loop into a standalone interactive app. It's in early development; the plugin in this repo is the system behind it and works today. Landing page: **https://patryk-beep.github.io/Lyceum-App/**.
